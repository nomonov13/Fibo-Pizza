            ...
            <div className="container">
                ...
                <div className="grid grid-cols-3 gap-6 text-start">
                    {ActionArray.map((action, index) => {
                        return (
                            <div key={index} className='w-350 shadow-action-cart rounded-xl'>
                                <img src={action.img} alt={action.title[lang]} />
                                ...
                                <button className="  mx-5 mb-4 action-btn">Посмотреть</button>
                            </div>
                        )
                    })}
                </div>
